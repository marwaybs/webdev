...
function VidyoClient(plugInDivId, onStatus)
{
		...
		this.AssignViewToCompositeRenderer = function(viewId, viewStyle, remoteParticipants) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('viewStyle') && arguments[0].hasOwnProperty('remoteParticipants')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToCompositeRenderer", arguments[0].viewId, arguments[0].viewStyle, arguments[0].remoteParticipants);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, viewStyle: arguments[0].viewStyle, remoteParticipants: arguments[0].remoteParticipants});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("AssignViewToCompositeRenderer", viewId, viewStyle, remoteParticipants);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], viewStyle: arguments[1], remoteParticipants: arguments[2]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectNetworkInterfaceForMedia = function(networkInterface) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('networkInterface')){
					var params = VCUtils.jQuery.param({c: this.objId, networkInterface: (arguments[0].networkInterface ? arguments[0].networkInterface.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['networkInterface'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({c: this.objId, networkInterface: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetCertificateAuthorityList = function(certificateAuthorityList) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('certificateAuthorityList')){
					var params = VCUtils.jQuery.param({c: this.objId, certificateAuthorityList: arguments[0].certificateAuthorityList});
				} else {
				...
				var params = VCUtils.jQuery.param({c: this.objId, certificateAuthorityList: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.ShowAudioMeters = function(viewId, showMeters) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('showMeters')){
					arguments[0].viewId = UpdateViewOnDOM("ShowAudioMeters", arguments[0].viewId, arguments[0].showMeters);
					var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, showMeters: arguments[0].showMeters});
				} else {
				...
				arguments[0] = UpdateViewOnDOM("ShowAudioMeters", viewId, showMeters);
				var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], showMeters: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
	...
	this.VidyoDevice = function(){
		...
		this.DerivedEqual = function() {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				var params = VCUtils.jQuery.param({obj: this.objId, other: this.objId});
			} else if (arguments.length === 0){
				var params = VCUtils.jQuery.param({obj: this.objId, other: this.objId});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
		...
		this.AllowRemoteCameraControl = function(allow) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('allow')){
					var params = VCUtils.jQuery.param({c: this.objId, allow: arguments[0].allow});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['allow'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
				var params = VCUtils.jQuery.param({c: this.objId, allow: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.ShowCameraControl = function(show) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('show')){
					var params = VCUtils.jQuery.param({c: this.objId, show: arguments[0].show});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['show'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
				var params = VCUtils.jQuery.param({c: this.objId, show: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SetId = function(id) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('id')){
					var params = VCUtils.jQuery.param({r: this.objId, id: arguments[0].id});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['id'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
				var params = VCUtils.jQuery.param({r: this.objId, id: arguments[0]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
				...
				GetRequest("VidyoLocalRendererSetId?" + params, OnComplete, OnError);
			});
		}
	...
	this.VidyoEndpoint = function(viewId, viewStyle, remoteParticipants, consoleLogFilter, fileLogFilter, fileLogName) {
		...
		this.AssignViewToCompositeRenderer = function(viewId, viewStyle, remoteParticipants) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('viewStyle') && arguments[0].hasOwnProperty('remoteParticipants')){
					arguments[0].viewId = UpdateViewOnDOM("AssignViewToCompositeRenderer", arguments[0].viewId, arguments[0].viewStyle, arguments[0].remoteParticipants);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, viewStyle: arguments[0].viewStyle, remoteParticipants: arguments[0].remoteParticipants});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'viewStyle', 'remoteParticipants'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 3 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string") && (typeof(arguments[2]) === "number")){
				arguments[0] = UpdateViewOnDOM("AssignViewToCompositeRenderer", viewId, viewStyle, remoteParticipants);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], viewStyle: arguments[1], remoteParticipants: arguments[2]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.SelectNetworkInterfaceForMedia = function(networkInterface) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('networkInterface')){
					var params = VCUtils.jQuery.param({e: this.objId, networkInterface: (arguments[0].networkInterface ? arguments[0].networkInterface.objId : 0)});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['networkInterface'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
				var params = VCUtils.jQuery.param({e: this.objId, networkInterface: (arguments[0] ? arguments[0].objId : 0)});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
		...
		this.ShowAudioMeters = function(viewId, showMeters) {
			...
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('showMeters')){
					arguments[0].viewId = UpdateViewOnDOM("ShowAudioMeters", arguments[0].viewId, arguments[0].showMeters);
					var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, showMeters: arguments[0].showMeters});
				} else {
					return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'showMeters'], Object.keys(arguments[0])).error);
				}
			} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "boolean")){
				arguments[0] = UpdateViewOnDOM("ShowAudioMeters", viewId, showMeters);
				var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], showMeters: arguments[1]});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
			}
			return new Promise(function(resolve, reject){
	...
	this.VidyoNetworkInterface = function(){
		...
		this.Destruct = function() {
			GetRequest("VidyoNetworkInterfaceDestruct?" + VCUtils.jQuery.param({ n: this.objId }), function(){}, function(){});
			delete objects[this.objId];
		}
		...
		this.GetAddress = function() {
			var args = [].slice.apply(arguments);
			if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
				var params = VCUtils.jQuery.param({n: this.objId});
			} else if (arguments.length === 0){
				var params = VCUtils.jQuery.param({n: this.objId});
			} else {
				return Promise.reject(new Error('Invalid Parameters'));
	...
	var callbacks = {
		...
		VidyoConnectorOnNetworkInterfaceAdded: function(response) {
			...
			VCUtils.jQuery.extend(VidyoNetworkInterfaceObj, response.VidyoNetworkInterface);
			...
			try {
				...
				return GetRequest("VidyoConnectorOnNetworkInterfaceAddedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnNetworkInterfaceRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnNetworkInterfaceRemovedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnNetworkInterfaceSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnNetworkInterfaceSelectedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoConnectorOnNetworkInterfaceStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoConnectorOnNetworkInterfaceStateUpdatedComplete?" + VCUtils.jQuery.param({ c: response.VidyoConnector ? response.VidyoConnector.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		...
		VidyoEndpointOnNetworkInterfaceAdded: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnNetworkInterfaceAddedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoEndpointOnNetworkInterfaceRemoved: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnNetworkInterfaceRemovedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoEndpointOnNetworkInterfaceSelected: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnNetworkInterfaceSelectedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
		VidyoEndpointOnNetworkInterfaceStateUpdated: function(response) {
			...
			try {
				...
				return GetRequest("VidyoEndpointOnNetworkInterfaceStateUpdatedComplete?" + VCUtils.jQuery.param({ e: response.VidyoEndpoint ? response.VidyoEndpoint.objId : 0, networkInterface: response.VidyoNetworkInterface ? response.VidyoNetworkInterface.objId : 0 }), function(){}, function(){});
			}
		},
